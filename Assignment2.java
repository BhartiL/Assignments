...
public class Assignment2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(" ");
											/*Problem-5 */
		Customer C=A.new Customer("David",5.90);	 			/*Creating Customer class object and Passing Customer Name
												and Price of Pizza values in Customer constructor*/
		C.addPizzaToOrder("ChickenPizza",2);					/*Execution of addPizzaToOrder function by Passing Pizza Type 
												and Quantity of Pizza*/
		System.out.println("Money Spent on Pizza by "+C.customerName+" : "+C.calculateAmount());/* Execution of calculateAmount function which calculates Money/Amount
														the customer spent and Printing the output*/
